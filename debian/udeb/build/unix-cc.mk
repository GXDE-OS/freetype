...
CFLAGS   := -c -Wall -g -O2 -ffile-prefix-map=/dde/freetype-2.12.1+dfsg=. -fstack-protector-strong -Wformat -Werror=format-security -fvisibility=hidden  -I/usr/include/libpng16 -pthread \
...
# Linker flags.
#
LDFLAGS := -Wl,-z,relro -Wl,-z,now -lz -lpng16 -lz -pthread -lpthread
